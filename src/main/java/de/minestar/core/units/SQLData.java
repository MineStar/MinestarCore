...
public class SQLData {
    ...
    // VARS
    private DataContainerNBTSQL dataContainer;
    private String playerName;

    public SQLData(String playerName) {
        this.playerName = playerName;
        this.dataContainer = new DataContainerNBTSQL();
    }
    ...
    public void save() {
        if (this.dataContainer != null) {
            this.dataContainer.save(this.playerName);
        } else {
    ...
    public void load() {
        if (this.dataContainer != null) {
            this.dataContainer.load(this.playerName);
        } else {
